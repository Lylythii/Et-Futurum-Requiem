...
public class BlockTourmalineBlock extends Block implements IConfigurable {
	
	public BlockTourmalineBlock() {
		this(Material.rock);
	}
	public BlockTourmalineBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("tourmaline_block");
		setBlockName(Utils.getUnlocalisedName("tourmaline_block"));
