...
public class BlockDiamondBlock extends Block implements IConfigurable {
	
	public BlockDiamondBlock() {
		this(Material.rock);
	}
	public BlockDiamondBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("diamond_block");
		setBlockName(Utils.getUnlocalisedName("diamond_block"));
