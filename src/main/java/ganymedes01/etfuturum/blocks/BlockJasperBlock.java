...
public class BlockJasperBlock extends Block implements IConfigurable {
	
	public BlockJasperBlock() {
		this(Material.rock);
	}
	public BlockJasperBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("jasper_block");
		setBlockName(Utils.getUnlocalisedName("jasper_block"));
