...
public class BlockJadeBlock extends Block implements IConfigurable {
	
	public BlockJadeBlock() {
		this(Material.rock);
	}
	public BlockJadeBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("jade_block");
		setBlockName(Utils.getUnlocalisedName("jade_block"));
