...
public class BlockBerylBlock extends Block implements IConfigurable {
	
	public BlockBerylBlock() {
		this(Material.rock);
	}
	public BlockBerylBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("beryl_block");
		setBlockName(Utils.getUnlocalisedName("beryl_block"));
