...
public class BlockSapphireBlock extends Block implements IConfigurable {
	...
	public BlockSapphireBlock(Material material) {
		...
		setBlockTextureName("sapphire_block");
		setBlockName(Utils.getUnlocalisedName("sapphire_block"));
