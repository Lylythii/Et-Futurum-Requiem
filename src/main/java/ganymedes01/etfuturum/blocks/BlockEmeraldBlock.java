...
public class BlockEmeraldBlock extends Block implements IConfigurable {
	
	public BlockEmeraldBlock() {
		this(Material.rock);
	}
	public BlockEmeraldBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("emerald_block");
		setBlockName(Utils.getUnlocalisedName("emerald_block"));
