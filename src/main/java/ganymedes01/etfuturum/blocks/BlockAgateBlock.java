...
public class BlockAgateBlock extends Block implements IConfigurable {
	
	public BlockAgateBlock() {
		this(Material.rock);
	}
	public BlockAgateBlock(Material material) {
		super(material);
		setHardness(1.5F);
		setResistance(1.5F);
		setStepSound(ConfigSounds.newBlockSounds ? ModSounds.soundGemstoneBlock : soundTypeGlass);
		setBlockTextureName("agate_block");
		setBlockName(Utils.getUnlocalisedName("agate_block"));
